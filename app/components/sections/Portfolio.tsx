...
const categories: PortfolioCategory[] = [
  {
    ...
    coverImage: "/corporate-conference-event-photography.jpg",
    images: [
      {
        src: "/abba-tribute-event-edinburgh.jpg",
        alt: "ABBA Event",
        title: "ABBA Tribute Event",
      },
      {
        src: "/conference-keynote-speaker.jpg",
        alt: "Conference Speaker",
        title: "Wellness Conference",
      },
      {
        src: "/corporate-presentation-filming.jpg",
        alt: "Presentation",
        title: "Conference Presentation",
      },
      {
        src: "/event-speaker-corporate.jpg",
        alt: "Event Speaker",
  ...
  },
  {
    ...
    coverImage: "/fine-dining-food-plating-edinburgh.jpg",
    images: [
      {
        src: "/fine-dining-plating-restaurant.jpg",
        alt: "Fine Dining",
        title: "Fine Dining Presentation",
      },
      {
        src: "/beef-wellington-culinary.jpg",
        alt: "Beef Wellington",
        title: "Beef Wellington",
      },
      {
        src: "/chef-demonstration-kitchen.jpg",
        alt: "Chef Demo",
        title: "Chef Demonstration",
      },
      {
        src: "/culinary-workshop-cooking.jpg",
        alt: "Culinary Demo",
  ...
  },
  {
    ...
    coverImage: "/edinburgh-skyline-sunset-scotland.jpg",
    images: [
      {
        src: "/edinburgh-skyline-drone-photography.jpg",
        alt: "Edinburgh Sunset",
        title: "Edinburgh Skyline",
      },
      { src: "/bass-rock-seabird-colony.jpg", alt: "Bass Rock", title: "Bass Rock" },
      {
        src: "/edinburgh-autumn-cityscape.jpg",
        alt: "Edinburgh Autumn",
        title: "Edinburgh in Autumn",
      },
      {
        src: "/scotland-coastal-sunset-water.jpg",
